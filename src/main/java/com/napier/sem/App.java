...
public class App {
    public static void main(String[] args) {
        ...
        ArrayList<Employee> dept = a.getSalariesByDepartment("Sales");
        ...
        //print all salaries of a department from database
        a.printSalariesOfAaDepartment(dept);
    }
    ...
    public ArrayList<Employee> getAllSalariesOfGivenRole() {
        try {
            // Create an SQL statement
            Statement stmt = con.createStatement();
            // Create string for SQL statement
    ...
    public void printSalariesOfGivenRole(ArrayList<Employee> employees) {
        // Print header
        System.out.println(String.format("%-10s %-15s %-20s %-8s", "Emp No", "First Name", "Last Name", "Salary"));
        // Loop over all employees in the list
        for (Employee emp : employees) {
